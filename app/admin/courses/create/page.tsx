    ...
    <>
      ...
      <Card>
        <CardHeader>
          ...
          <CardDescription>
            Provide basic infomation about the course
          </CardDescription>
        </CardHeader>
        <CardContent>
            <Form {...form}>
...
function zodResolver(courseSchema: any): import("react-hook-form").Resolver<CourseSchemaType, any, CourseSchemaType> | undefined {
    throw new Error("Function not implemented.");
}
